        ...
        <div className="relative">
          <div className="relative aspect-video">
            ...
            <IconButton
              ...
              className="absolute left-0 sm:left-2 top-[45%] -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white z-10 h-8"
            ...
            <IconButton
              onClick={nextImage}
              className="absolute right-0 sm:right-2 top-[45%] -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white z-10 h-8"
